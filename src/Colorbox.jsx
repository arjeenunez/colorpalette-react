...
import { ColorboxComponent, SpanComponentOne, SpanComponentTwo, CopyButtonComponent, BoxContentContainer, CopyMessageContainer, CopyOverlayComponent } from './styles/ColorboxStyles';
    ...
    return (
        <CopyToClipboard text={format} onCopy={changeCopyState}>
            <ColorboxComponent backgroundColor={format} showLink={showLink}>
                ...
                {showLink && (
                    <SpanComponentTwo isDark={isDarkColor} onClick={handleMoreClick}>
                        MORE
                    </SpanComponentTwo>
                )}
            </ColorboxComponent>
